// laba2_1.cpp : Определяет точку входа для приложения.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
	{
		HWND hWnd2_2 = FindWindow(0, _T("laba2_2"));
		if (hWnd2_2)
			MessageBox(hWnd, TEXT("I've found descriptor!"), TEXT("Message box from first project"), MB_OK);
		else
			MessageBox(hWnd, TEXT("I can't found descriptor!"), TEXT("Message box from first project"), MB_OK);

		PostMessage(hWnd2_2, WM_USER + 1, (WPARAM)hWnd, lParam);
		break;
	}
	case WM_RBUTTONDOWN:
	{
		HWND hWnd2_2 = FindWindow(0, _T("laba2_2"));
		PostMessage(hWnd2_2, WM_USER + 2, (WPARAM)hWnd, lParam);
		break;
	}
    case WM_DESTROY:
        PostQuitMessage(0);

// laba2_2.cpp : Определяет точку входа для приложения.
//
...
LRESULT CALLBACK WndProc(HWND hWnd2, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_USER + 1:
	{
		MessageBox(hWnd2, TEXT("Got users discriptor"), TEXT("Message box from second project"), MB_OK);
		MoveWindow((HWND)wParam, 0, 0, 0, 0, 0);
		break;
	}
	case WM_USER + 2:
	{
